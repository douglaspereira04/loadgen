...
template <typename _IntType = int> class skewed_latest_int_distribution {
...
public:
    ...
    skewed_latest_int_distribution(
        acknowledged_counter<_IntType> *&basis,
        zipfian_int_distribution<_IntType> *&zipfian_int_distribution) {
        basis_ = basis;
        zipfian_int_distribution_ = zipfian_int_distribution;
        last_value_ = basis_->last_value();
    }
